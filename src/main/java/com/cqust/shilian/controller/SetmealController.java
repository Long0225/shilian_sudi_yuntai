package com.cqust.shilian.controller;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.cqust.shilian.common.Result;
import com.cqust.shilian.dto.DishDto;
import com.cqust.shilian.dto.SetmealDto;
...
import com.cqust.shilian.service.CategoryService;
import com.cqust.shilian.service.DishService;
import com.cqust.shilian.service.SetmealDishService;
import com.cqust.shilian.service.SetmealService;
...
public class SetmealController {
     ...
     */
    @DeleteMapping
    @CacheEvict(value = "setmealCache",allEntries = true)  //删除所有
    ...
    public Result<List<Setmeal>> list(Setmeal setmeal) {
        ...
        queryWrapper.eq(null != setmeal.getStatus(), Setmeal::getStatus, setmeal.getStatus());  //1
    ...
    public Result<String> setmealStatus(@PathVariable Integer status, @RequestParam(value = "ids") List <Long> ids) {
        for (Long id : ids) {
        ...
        return status == 0 ? Result.success("套餐停售成功") : Result.success("套餐启售成功");
    }
